...
import { ArrowRight, Award, ExternalLink, BookOpen } from 'lucide-react';
...
const Home: React.FC = () => {
  ...
  return (
    <div className="bg-white dark:bg-gray-900">
      ...
      {/* Open Source Spotlight Section */}
      <section className="py-20 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">

          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-4">
              Open Source <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Impact</span>
            </h2>
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto text-sm sm:text-base">
              Listed as an official contributor to major frameworks empowering the global developer and AI research community.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 overflow-hidden shadow-sm">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              {/* LEFT: Text content — centered structure */}
              <div className="p-8 lg:p-12 flex flex-col items-center justify-center text-center gap-7 border-b lg:border-b-0 lg:border-r border-gray-200 dark:border-gray-700">

                <div className="space-y-4 flex flex-col items-center">
                  <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-800 shadow-sm">
                  ...
                  <h3 className="text-2xl sm:text-3xl font-extrabold text-gray-900 dark:text-white leading-tight text-center">
                    Flower AI Framework
                  </h3>
                </div>

                <p className="text-gray-600 dark:text-gray-400 text-sm sm:text-base leading-relaxed max-w-md text-center mt-4">
                  Recognized globally in the major <span className="font-semibold text-gray-900 dark:text-white">Flower 1.20</span> stable release, empowering researchers and engineers with scalable federated learning solutions.
                </p>

                {/* CTAs */}
                <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
                  <a
                    href="https://flower.ai/blog/2025-07-29-announcing-flower-1.20-release"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-blue-600 to-purple-600 text-white text-sm font-bold rounded-xl hover:from-purple-600 hover:to-blue-600 transition-all duration-300 shadow-md hover:-translate-y-0.5"
                  >
                    <ExternalLink className="w-4 h-4" /> View Announcement
                  </a>
                  <a
                    href="https://github.com/adap/flower/pulls?q=is%3Apr+author%3AAjayKumbham"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-6 py-2.5 bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm font-bold rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-300 border border-gray-200 dark:border-gray-700 shadow-sm hover:-translate-y-0.5"
                  >
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" />
                    </svg>
              ...
              {/* RIGHT: Blog image — cropped to show contributor section */}
              <div className="flex flex-col">
                {/* Browser chrome */}
                <div className="flex items-center gap-2 px-4 py-2.5 bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 flex-shrink-0">
                  <div className="flex gap-1.5">
                    <div className="w-2.5 h-2.5 rounded-full bg-red-400" />
                    <div className="w-2.5 h-2.5 rounded-full bg-yellow-400" />
                    <div className="w-2.5 h-2.5 rounded-full bg-green-400" />
                  </div>
                  <div className="flex-1 bg-white dark:bg-gray-700 rounded px-2.5 py-0.5 text-[11px] text-gray-400 font-mono truncate">
                    flower.ai/blog · Announcing Flower 1.20
                  </div>
                </div>

                {/* Image anchored from bottom — shows "Thanks to our contributors" section with the name */}
                <a
                  href="https://flower.ai/blog/2025-07-29-announcing-flower-1.20-release"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                >
                  {/* Pin image to bottom so contributors heading is at the top of the visible window */}
                  <img
                    src="/flower-1.20-announcement.png"
                    alt="Flower 1.20 release — Kumbham Ajay Goud listed as contributor"
                    className="absolute bottom-0 left-0 w-full h-auto transition-transform duration-500 group-hover:scale-[1.03]"
                  />
                  {/* Subtle hover overlay */}
                  <div className="absolute inset-0 bg-gradient-to-t from-gray-900/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
                    <span className="text-white text-xs font-medium flex items-center gap-1.5">
                      <ExternalLink className="w-3.5 h-3.5" /> Read the full announcement →
                    </span>
                  </div>
                </a>
              </div>
